...
import { SPLASH_TIMEOUT } from './Constants';
  ...
  render() {
    ...
    return (
      <View style={[styles.container]}>
        {showStatusBar && (
          <StatusBar backgroundColor={backgroundColor || null} animated translucent={translucent} />
        )}
        {!animationDone && <View style={StyleSheet.absoluteFill} />}
        <View style={styles.containerGlue}>
          {!animationDone && <Animated.View style={_staticBackground(logoOpacity, backgroundColor)} />}
          ...
          {!animationDone && (
            <Animated.Image
              ...
              style={
                (disableImageBackgroundAnimation && _staticBackground(logoOpacity, backgroundColor),
                disableImageBackgroundAnimation &&
                  _dynamicImageBackground(imageScale, logoOpacity, backgroundColor))
              }
            />
          )}
          {!animationDone && (
...
AnimatedSplash.defaultProps = {
  logoImage: require('./assets/default-logo.png'),
  duration: SPLASH_TIMEOUT,
  disableAppScale: false,
};
